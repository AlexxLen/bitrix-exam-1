	...
	<div class="col-lg-12">
		...
		<div class="card-body">
			...
			<table class="table table-striped">
				<thead>
				<tr>
					<th><?=Loc::getMessage('ITEM_NUMBER')?></th>
					<th><?=Loc::getMessage('ITEM_PRODUCT')?></th>
					<th><?=Loc::getMessage('ITEM_CATEGORY')?></th>
					<th><?=Loc::getMessage('ITEM_CITY')?></th>
					<th><?=Loc::getMessage('ITEM_QUANTITY')?></th>
				</tr>
				</thead>
				<tbody>
