...
<div class="row justify-content-center">
	<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
		...
		<div class="card-body">
			...
			<div class="col-12">
			<label for="yourUsername" class="form-label"><?=Loc::getMessage('AUTH_LOGIN');?></label>
			...
			<div class="col-12">
			<label for="yourPassword" class="form-label"><?=Loc::getMessage('AUTH_PASSWORD');?></label>
			<input 
				class="form-control" id="yourPassword" required
				type="password" name="USER_PASSWORD" maxlength="255" autocomplete="off" 
			>
			<div class="invalid-feedback"><?=Loc::getMessage('PASSWORD_INVALID');?></div>
			</div>
			...
			<?if($arResult["CAPTCHA_CODE"]):?>
				<!-- IF USED CAPTCHA -->
				<div class="col-12">
				<label class="form-label"><?=Loc::getMessage('AUTH_CAPTCHA_PROMT');?>
				</label>
				<div class="input-group has-validation">
			...
			<div class="col-12">
			<button 
				class="btn btn-primary w-100" type="submit" name="Login"><?=Loc::getMessage('AUTH_AUTHORIZE');?>
			</button>
			</div>
			...
			<?if($arParams["NOT_SHOW_LINKS"] != "Y" && $arResult["NEW_USER_REGISTRATION"] == "Y"):?>
				<noindex>
					<div class="col-12">
						<p class="small mb-0"><?=Loc::getMessage('AUTH_FIRST_ONE');?>
