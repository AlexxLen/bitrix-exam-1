...
<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
	...
	<div class="card-body">
		...
		<div class="col-12">
			...
			<div class="invalid-feedback"><?=Loc::getMessage('LOGIN_INVALID')?></div>
			</div>
		</div>
		<div class="col-12">
			<label class="form-label"><?=Loc::getMessage('USER_CHECKWORD')?></label>
			<div class="input-group has-validation">
			<input class="form-control" required type="text" name="USER_CHECKWORD" maxlength="50" value="<?=$arResult["USER_CHECKWORD"]?>" />
			<div class="invalid-feedback"><?=Loc::getMessage('USER_CHECKWORD_INVALID')?></div>
			</div>
		</div>
		<div class="col-12">
			<label class="form-label"><?=Loc::getMessage('USER_PASSWORD')?></label>
			<div class="input-group has-validation">
			<input class="form-control" required type="password" name="USER_PASSWORD" maxlength="255" value="<?=$arResult["USER_PASSWORD"]?>" />
			<div class="invalid-feedback"><?=Loc::getMessage('USER_PASSWORD_INVALID')?></div>
			</div>
		</div>
		<div class="col-12">
			<label class="form-label"><?=Loc::getMessage('USER_CONFIRM_PASSWORD')?></label>
			<div class="input-group has-validation">
			...
			<div class="invalid-feedback"><?=Loc::getMessage('USER_CONFIRM_PASSWORD_INVALID')?></div>
			</div>
		</div>
		...
		<div class="col-12">
			...
			<div class="invalid-feedback"><?=Loc::getMessage('CAPTCHA_INVALID')?></div>
			</div>
		</div>
		<div class="col-12">
		...
		<div class="col-12">
			<button class="btn btn-primary w-100" type="submit" name="change_pwd" value="<?=Loc::getMessage('CHANGE_PWD_BTN')?>"><?=Loc::getMessage('CHANGE_PWD_BTN')?></button>
		</div>
		...
		<div class="field">
			<p class="small"><a href="<?=$arResult["AUTH_AUTH_URL"]?>"><b><?=Loc::getMessage('AUTH')?></b></a></p>  <!-- AUTH_URL -->
		</div>
